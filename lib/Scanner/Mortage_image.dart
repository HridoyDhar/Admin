...
Future<void> main() async {
  runApp(Mortage_image());
}

class Mortage_image extends StatefulWidget {
  @override
  _Mortage_imageState createState() => _Mortage_imageState();
}

class _Mortage_imageState extends State<Mortage_image> {
  File? file;
